...
public class OutletSalesFragment extends Fragment {
    ...
    EditText editTextDate, editTextProductPrice, editTextProductQuantity, editTextBaseVolume;
    Button buttonSubmit;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_outlet_sales, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editTextProductPrice = (EditText) view.findViewById(R.id.edit_text_product_price);
        editTextProductQuantity = (EditText) view.findViewById(R.id.edit_text_product_quantity);
        editTextBaseVolume = (EditText) view.findViewById(R.id.edit_text_base_volume);
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String input_product_price= editTextProductPrice.getText().toString();
                if (TextUtils.isEmpty(input_product_price)) {
                    editTextProductPrice.setError("Enter product price");
                    return;
                }

                String input_product_quantity = editTextProductQuantity.getText().toString();
                if (TextUtils.isEmpty(input_product_quantity)) {
                    editTextProductQuantity.setError("Enter product quantity");
                    return;
                }

                String input_base_volume = editTextBaseVolume.getText().toString();
                ...
                AndroidNetworking.post(URLs.SUBMIT_OUTLET_SALES)
                        ...
                        .addBodyParameter("product_price", input_product_price)
                        .addBodyParameter("quantity", input_product_quantity)
                        .addBodyParameter("base_volume", input_base_volume)
    ...
    public void populateActivationSpinner(){
        ...
        final List<String> listCampaign = new ArrayList<String>();
    ...
    public void fetchActivationLocations(String activation_name){
        ...
        final List<String> listLocation = new ArrayList<String>();
