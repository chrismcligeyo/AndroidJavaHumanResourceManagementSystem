...
public class ActivationExpensesItemDetailsActivity extends AppCompatActivity {
    ...
    String id ="", expenses_id ="", item_supplier ="", item_name ="", item_description ="", item_unit_cost ="",
            item_quantity ="", item_days ="", item_amount ="", created_at ="", updated_at ="", requisition_status = "", reconciliation_status = "",  submitted_status = "", item_reconciliation_status = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog dialog = new Dialog(ActivationExpensesItemDetailsActivity.this);
                ...
                buttonEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (TextUtils.isEmpty(item_name)) {
                            Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Please enter item name", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_description = editTextItemDescription.getText().toString();
                        if (TextUtils.isEmpty(item_description)) {
                            Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Please enter item description", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_supplier = editTextItemSupplier.getText().toString();
                        if (TextUtils.isEmpty(item_supplier)) {
                            Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Please enter item supplier", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_unit_cost = editTextItemUnitCost.getText().toString();
                        if (TextUtils.isEmpty(item_unit_cost)) {
                            Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Please enter unit cost", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_quantity = editTextItemQuantity.getText().toString();
                        if (TextUtils.isEmpty(item_quantity)) {
                            Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Please enter quantity", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_days = editTextQuantityDays.getText().toString();
                        if (TextUtils.isEmpty(item_days)) {
                            Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Please enter days", Toast.LENGTH_LONG).show();
                            return;
                        }
                        ...
                        AndroidNetworking.post(URLs.ACTIVATION_EXPENSES_ITEM_EDIT)
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        try {
                                            ...
                                            if (success==1){
                                                ...
                                                Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Success, item edit", Toast.LENGTH_LONG).show();
                                                dialog.dismiss();
                                                finish();

                                            }else{
                                                Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Error, item not edit", Toast.LENGTH_LONG).show();
                                            }
                                        } catch (JSONException e) {
                                            Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Error, something went wrong", Toast.LENGTH_LONG).show();
                                        }
                                    }
                                    @Override
        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pDialog = new SweetAlertDialog(ActivationExpensesItemDetailsActivity.this, SweetAlertDialog.PROGRESS_TYPE);
                pDialog.getProgressHelper().setBarColor(Color.parseColor("#1a365d"));
                pDialog.setTitleText("Deleting...");
                pDialog.setCancelable(false);
                pDialog.show();
               
                AndroidNetworking.post(URLs.ACTIVATION_EXPENSES_ITEM_DELETE)
                        .addBodyParameter("id", id)
                        .setTag("reset_code")
                        .setPriority(Priority.HIGH)
                        .build()
                               ...
                               int success=0;
                                ...
                                try {
                                    ...
                                    if (success==1){
                                        ...
                                        Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Success, item deleted", Toast.LENGTH_LONG).show();
                                        finish();

                                    }else{
                                        Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Error, item not deleted", Toast.LENGTH_LONG).show();
                                    }
                                } catch (JSONException e) {
                                    Toast.makeText(ActivationExpensesItemDetailsActivity.this, "Error, something went wrong", Toast.LENGTH_LONG).show();
                                }
                                ...
                                .getAsJSONObject(new JSONObjectRequestListener() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        if(success==1){
                                            ...
                                            new SweetAlertDialog(ActivationExpensesItemDetailsActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                                                    ...
                                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                                        ...
                                                        public void onClick(SweetAlertDialog sDialog) {
                                                            ...
                                                            ActivationExpensesItemDetailsActivity.this.finish();
                                                        }
                                                    })
                                                    .show();
                                            ...
                                            new SweetAlertDialog(ActivationExpensesItemDetailsActivity.this, SweetAlertDialog.ERROR_TYPE)
                                                    .setTitleText("Error!")
    ...
    private void getOverallPermission() {

        if (ContextCompat.checkSelfPermission(ActivationExpensesItemDetailsActivity.this, Manifest.permission.CAMERA)
            ...
            if (ContextCompat.checkSelfPermission(ActivationExpensesItemDetailsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ContextCompat.checkSelfPermission(ActivationExpensesItemDetailsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
    ...
    public void getCameraPermission() {
        ...
        if (ContextCompat.checkSelfPermission(ActivationExpensesItemDetailsActivity.this,
                Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED) {

            // Permission is not granted
            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(ActivationExpensesItemDetailsActivity.this,
                    Manifest.permission.CAMERA)) {
                // Show an explanation to the user *asynchronously* -- don't block
                // ActivationExpensesItemDetailsActivity.this thread waiting for the user's response! After the user
                // sees the explanation, try again to request the permission.
            } else {
                // No explanation needed; request the permission
                ActivityCompat.requestPermissions(ActivationExpensesItemDetailsActivity.this,
    ...
    private String saveToInternalStorage(Bitmap bitmapImage, String fileName){
        ContextWrapper cw = new ContextWrapper(ActivationExpensesItemDetailsActivity.this);
    ...
    private void persistImage(Bitmap bitmap, String filename) {
        imageFile = new File(ActivationExpensesItemDetailsActivity.this.getCacheDir(), filename + ".jpg");
        try {
    ...
    public String getFileName(Uri uri) {
        ...
        if (uri.getScheme().equals("content")) {
            Cursor cursor = ActivationExpensesItemDetailsActivity.this.getContentResolver().query(uri, null, null, null, null);
            try {
