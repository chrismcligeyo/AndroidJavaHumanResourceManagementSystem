...
public class PendingExpensesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_pending_general_expenses, container, false);
    }
            ...
            public void onClick(View view) {
                ...
                buttonCreate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AndroidNetworking.post(URLs.GENERAL_EXPENSES_CREATE)
                                .addBodyParameter("expense_type", "0")
    ...
    public void fetchGeneralExpenses(){
        ...
        pDialog.show();
        AndroidNetworking.post(URLs.GENERAL_PENDING_EXPENSES)
