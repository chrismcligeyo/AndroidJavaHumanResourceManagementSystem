...
import com.androidstudy.alfoneshub.expenses.activations.fragments.ProcessedExpensesFragment;
import com.androidstudy.alfoneshub.expenses.activations.fragments.PendingExpensesFragment;
import com.google.android.material.tabs.TabLayout;

public class ActivationExpensesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Activation Expenses");
