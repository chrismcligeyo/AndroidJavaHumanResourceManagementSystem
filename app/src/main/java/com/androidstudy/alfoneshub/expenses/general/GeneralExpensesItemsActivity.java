...
public class GeneralExpensesItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog dialog = new Dialog(GeneralExpensesItemsActivity.this);
                ...
                buttonCreate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (TextUtils.isEmpty(item_name)) {
                            Toast.makeText(GeneralExpensesItemsActivity.this, "Please enter item name", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_description = editTextItemDescription.getText().toString();
                        if (TextUtils.isEmpty(item_description)) {
                            Toast.makeText(GeneralExpensesItemsActivity.this, "Please enter item description", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_supplier = editTextItemSupplier.getText().toString();
                        if (TextUtils.isEmpty(item_supplier)) {
                            Toast.makeText(GeneralExpensesItemsActivity.this, "Please enter item supplier", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_unit_cost = editTextItemUnitCost.getText().toString();
                        if (TextUtils.isEmpty(item_unit_cost)) {
                            Toast.makeText(GeneralExpensesItemsActivity.this, "Please enter unit cost", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_quantity = editTextItemQuantity.getText().toString();
                        if (TextUtils.isEmpty(item_quantity)) {
                            Toast.makeText(GeneralExpensesItemsActivity.this, "Please enter quantity", Toast.LENGTH_LONG).show();
                            return;
                        }

                        String item_days = editTextQuantityDays.getText().toString();
                        if (TextUtils.isEmpty(item_days)) {
                            Toast.makeText(GeneralExpensesItemsActivity.this, "Please enter days", Toast.LENGTH_LONG).show();
                            return;
                        }
                        ...
                        AndroidNetworking.post(URLs.GENERAL_EXPENSES_ITEM_CREATE)
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        try {
                                            ...
                                            if (success==1){
                                                ...
                                                Toast.makeText(GeneralExpensesItemsActivity.this, "Success, item created", Toast.LENGTH_LONG).show();
                                                ...
                                                Toast.makeText(GeneralExpensesItemsActivity.this, "Error, item not created", Toast.LENGTH_LONG).show();
                                            }
                                        } catch (JSONException e) {
                                            Toast.makeText(GeneralExpensesItemsActivity.this, "Error, something went wrong", Toast.LENGTH_LONG).show();
                                        }
                                    }
                                    @Override
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pDialog = new SweetAlertDialog(GeneralExpensesItemsActivity.this, SweetAlertDialog.PROGRESS_TYPE);
                pDialog.getProgressHelper().setBarColor(Color.parseColor("#1a365d"));
                pDialog.setTitleText("Submitting...");
                pDialog.setCancelable(false);
                pDialog.show();

                AndroidNetworking.post(URLs.GENERAL_EXPENSES_SUBMIT)
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (success==1){
                                        ...
                                        Toast.makeText(GeneralExpensesItemsActivity.this, "Success, requisition submitted", Toast.LENGTH_LONG).show();
                                        linearLayoutExpenseItem.setVisibility(View.GONE);

                                    }else{
                                        Toast.makeText(GeneralExpensesItemsActivity.this, "Error, item not deleted", Toast.LENGTH_LONG).show();
                                    }
                                } catch (JSONException e) {
                                    Toast.makeText(GeneralExpensesItemsActivity.this, "Error, something went wrong", Toast.LENGTH_LONG).show();
                                }
    ...
    public void fetchExpensesItems(){
        ...
        AndroidNetworking.post(URLs.GENERAL_EXPENSES_ITEMS)
                .addBodyParameter("expenses_id", id)
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        expensesItemAdapter = new ExpensesItemAdapter(GeneralExpensesItemsActivity.this, expensesItemList);
                        recyclerViewExpensesItem.setAdapter(expensesItemAdapter);
                        recyclerViewExpensesItem.addOnItemTouchListener(
                                new MyRecyclerItemClickListener(GeneralExpensesItemsActivity.this, new MyRecyclerItemClickListener.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(View view, int position) {
                                        ExpensesItem expensesItem = expensesItemList.get(position);
                                        Intent intent = new Intent(GeneralExpensesItemsActivity.this, GeneralExpensesItemDetailsActivity.class);
                    ...
                    public void onError(ANError anError) {
                        ...
                        new SweetAlertDialog(GeneralExpensesItemsActivity.this, SweetAlertDialog.ERROR_TYPE)
                                .setTitleText("ERROR!")
